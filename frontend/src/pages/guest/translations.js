...
const en = {
  ...
  today: 'Today',
  yesterday: 'Yesterday',
  notServing: 'Currently not serving',
  ...
  cabTitle: 'Cab Request',
  cabChoose: 'What would you like?',
  cabPickup: 'Pickup & Drop',
  cabPickupSub: 'A point-to-point ride',
  cabSight: 'Sightseeing',
  cabSightSub: 'Tell us where you’d like to go',
  cabFrom: 'From',
  cabFromPh: 'e.g. Hotel lobby',
  cabTo: 'To',
  cabToPh: 'e.g. Airport',
  cabDetails: 'Where would you like to go?',
  cabTextPh: 'e.g. City tour, temples, shopping mall…',
  cabWhen: 'Pickup time',
  cabConfirm: 'Request cab',
  cabBack: 'Back',
...
const ru = {
  ...
  today: 'Сегодня',
  yesterday: 'Вчера',
  notServing: 'Сейчас не обслуживаем',
  kitchenHours: 'Часы работы кухни',
  ...
  cabTitle: 'Заказ такси',
  cabChoose: 'Что вы хотите?',
  cabPickup: 'Подача и трансфер',
  cabPickupSub: 'Поездка из точки в точку',
  cabSight: 'Экскурсия',
  cabSightSub: 'Расскажите, куда хотите поехать',
  cabFrom: 'Откуда',
  cabFromPh: 'напр. Лобби отеля',
  cabTo: 'Куда',
  cabToPh: 'напр. Аэропорт',
  cabDetails: 'Куда бы вы хотели поехать?',
  cabTextPh: 'напр. Тур по городу, храмы, торговый центр…',
  cabWhen: 'Время подачи',
  cabConfirm: 'Заказать такси',
  cabBack: 'Назад',
